...
function index_position(index::Int, n::Int, d::Int)::Tuple
...
function position_index(position::Tuple, n::Int, d::Int)::Int
...
function k_step_transition_probabilities(k::Int, P::Array{Float64,2})::Array{Float64}
