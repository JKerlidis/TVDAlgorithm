...
file = open("out/data/mle_float_poisson_offspring_psdbp_true.json")
...
file = open("out/data/mle_float_poisson_offspring_cbp_true.json")
data = read(file, String)
close(file)
...
savefig(mle_K_plot, "out/plots/poisson_offspring/MLE_K.png")
